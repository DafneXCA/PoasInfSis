...
<body>
    ...
    <div class="offcanvas offcanvas-start sidebar-div"  id="sidebar" >
        <div class="offcanvas-body sidebar-content">
            ...
            <a href="#" class="list-group-item"><i class="bi bi-book"></i>Información general</a>
            <a href="#" class="list-group-item"><i class="bi bi-card-checklist"></i>Operaciones y proyectos</a>
